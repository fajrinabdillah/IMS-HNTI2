...
export const DASHBOARD_GLASS = {
  ...
  incentive: {
    background: 'linear-gradient(145deg, rgba(200,169,106,0.12) 0%, rgba(47,143,111,0.08) 45%, rgba(192,48,48,0.05) 100%)',
    border: '1px solid rgba(200,169,106,0.25)',
    boxShadow: '0 0 28px rgba(200,169,106,0.07), inset 0 1px 0 rgba(255,255,255,0.05)',
    accent: 'var(--ims-gold)',
