...
const translations = {
  id: {
    ...
    nav_dashboard: 'Dasbor', nav_install_base: 'Install Base', nav_sph: 'Manajemen SPH', nav_pipeline: 'Pipeline',
    ...
    modality_mix: 'Modalitas Radiologi', installed_modality_mix: 'Modalitas Terinstal', project_type_mix: 'Komposisi Jenis Proyek',
    ...
    stage_tender: 'Proses Tender', stage_po_issued: 'PO Terbit', stage_inactive: 'Non-Aktif', stage_lost: 'Hilang',
    ...
    status_active: 'Aktif', status_won: 'Menang', status_lost: 'Kalah', status_inactive: 'Non-Aktif',
    ...
    sr_pipe_summary: 'Ringkasan Prospek',
    sr_pipe_count: 'Jumlah RS Prospek',
    sr_prospect_rs: 'RS Prospek',
    sr_prospect_rate: 'Rasio Prospek',
    sr_prospect_hint: 'Prospek = kunjungan dengan kebutuhan produk teridentifikasi (Produk + Hangat/Panas/Proposal)',
    sr_pipe_val: 'Estimasi Nilai (Rp juta)',
    sr_project_value: 'Estimasi Nilai Proyek (Rp juta)',
    sr_closest: 'RS Prospek Prioritas',
  ...
  en: {
    ...
    nav_dashboard: 'Dashboard', nav_install_base: 'Install Base', nav_sph: 'Quotation Mgmt', nav_pipeline: 'Pipeline',
    ...
    modality_mix: 'Radiology Modalities', installed_modality_mix: 'Installed Modalities', project_type_mix: 'Project Type Composition',
    ...
    stage_tender: 'Tender Process', stage_po_issued: 'PO Issued', stage_inactive: 'Inactive', stage_lost: 'Lost',
    ...
    status_active: 'Active', status_won: 'Won', status_lost: 'Lost', status_inactive: 'Inactive',
    ...
    sr_pipe_summary: 'Prospect Summary',
    sr_pipe_count: 'Prospect RS Count',
    sr_prospect_rs: 'Prospect Hospitals',
    sr_prospect_rate: 'Prospect Rate',
    sr_prospect_hint: 'Prospect = visit with identified product need (Product + Warm/Hot/Proposal)',
    sr_pipe_val: 'Est. Value (USD)',
    sr_project_value: 'Project Value Est. (Rp juta)',
    sr_closest: 'Priority Prospect RS',
