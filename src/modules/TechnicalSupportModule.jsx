...
import { Activity, AlertTriangle, CalendarDays, ClipboardList, FileCheck, Radiation, Users, Wrench } from 'lucide-react';
...
function TechnicalSupportModule({
  ...
  return (
    <div>
      ...
      {tab === 'bast' && <InstallationModule {...installProps} forcedTab="bast" />}
      {tab === 'training' && <InstallationModule {...installProps} forcedTab="training" />}
      {tab === 'exposure' && <InstallationModule {...installProps} forcedTab="exposure" />}
