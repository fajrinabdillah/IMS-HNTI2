...
import { FIELD_REPORTS_JUN_JUL_2026 } from '../data/fieldReportsJunJul2026.js';

const _SEED_FIELD_REPORTS_BASE = [
  ...
  { id: 'rpt_ht_w1', salesId: 'hatim', date: '2026-01-13', week: 'Minggu 2',
    ...
    pipeN: 3, pipeVal: 0, closest: 'RSUD Tugurejo Semarang',
  ...
  { id: 'rpt_ht_w2', salesId: 'hatim', date: '2026-01-27', week: 'Minggu 4',
    ...
    pipeN: 3, pipeVal: 0, closest: 'RSUD Pati',
  ...
  { id: 'rpt_ht_w3', salesId: 'hatim', date: '2026-02-14', week: 'Minggu 2',
    ...
    pipeN: 2, pipeVal: 0, closest: 'RSUD Tugurejo Semarang',
  ...
  { id: 'rpt_ht_w4', salesId: 'hatim', date: '2026-02-28', week: 'Minggu 4',
    ...
    pipeN: 2, pipeVal: 0, closest: 'RSUD Batang',
  ...
  { id: 'rpt_ht_w5', salesId: 'hatim', date: '2026-03-21', week: 'Minggu 3',
    ...
    pipeN: 2, pipeVal: 0, closest: 'RS Telogorejo Semarang',
  ...
  { id: 'rpt_ht_w6', salesId: 'hatim', date: '2026-04-11', week: 'Minggu 2',
    ...
    pipeN: 2, pipeVal: 0, closest: 'RS Mardi Rahayu Kudus',
  ...
  { id: 'rpt_ht_w7', salesId: 'hatim', date: '2026-05-09', week: 'Minggu 2',
    ...
    pipeN: 1, pipeVal: 0, closest: 'RS Mitra Keluarga Tegal',
  ...
  { id: 'rpt_dw_w1', salesId: 'dwi', date: '2026-01-15', week: 'Minggu 3',
    ...
    pipeN: 3, pipeVal: 0, closest: 'RS Pondok Indah Jakarta',
  ...
  { id: 'rpt_dw_w2', salesId: 'dwi', date: '2026-01-30', week: 'Minggu 4',
    ...
    pipeN: 3, pipeVal: 0, closest: 'RS Hermina Galaxy Bekasi',
  ...
  { id: 'rpt_dw_w3', salesId: 'dwi', date: '2026-02-13', week: 'Minggu 2',
    ...
    pipeN: 3, pipeVal: 0, closest: 'RSUD Tarakan Jakarta',
  ...
  { id: 'rpt_dw_w4', salesId: 'dwi', date: '2026-03-06', week: 'Minggu 1',
    ...
    pipeN: 3, pipeVal: 0, closest: 'RS Borromeus Bandung',
  ...
  { id: 'rpt_dw_w5', salesId: 'dwi', date: '2026-03-27', week: 'Minggu 4',
    ...
    pipeN: 2, pipeVal: 0, closest: 'RSUD Cibinong',
  ...
  { id: 'rpt_dw_w6', salesId: 'dwi', date: '2026-04-17', week: 'Minggu 3',
    ...
    pipeN: 3, pipeVal: 0, closest: 'RS Premier Bintaro',
  ...
  { id: 'rpt_dw_w7', salesId: 'dwi', date: '2026-05-08', week: 'Minggu 2',
    ...
    pipeN: 2, pipeVal: 0, closest: 'RSUD Cianjur',
  ...
  { id: 'rpt_ts_w1', salesId: 'tri', date: '2026-01-09', week: 'Minggu 2',
    ...
    pipeN: 3, pipeVal: 0, closest: 'RS Husada Utama Surabaya',
  ...
  { id: 'rpt_ts_w2', salesId: 'tri', date: '2026-01-23', week: 'Minggu 4',
    ...
    pipeN: 3, pipeVal: 0, closest: 'RS Lavalette Malang',
  ...
  { id: 'rpt_ts_w3', salesId: 'tri', date: '2026-02-13', week: 'Minggu 2',
    ...
    pipeN: 2, pipeVal: 0, closest: 'RS Husada Utama Surabaya',
    totalCost: 2280000, block: '-',
  ...
  { id: 'rpt_ts_w4', salesId: 'tri', date: '2026-03-04', week: 'Minggu 1',
    ...
    pipeN: 2, pipeVal: 0, closest: 'RSUD Mojokerto',
    totalCost: 1850000, block: '-',
  ...
  { id: 'rpt_ts_w5', salesId: 'tri', date: '2026-03-20', week: 'Minggu 3',
    ...
    pipeN: 2, pipeVal: 0, closest: 'RSUD Soewandhie Surabaya',
  ...
  { id: 'rpt_ts_w6', salesId: 'tri', date: '2026-04-10', week: 'Minggu 2',
    ...
    pipeN: 3, pipeVal: 0, closest: 'RS Premier Surabaya',
  ...
  { id: 'rpt_ts_w7', salesId: 'tri', date: '2026-04-24', week: 'Minggu 4',
    ...
    pipeN: 2, pipeVal: 0, closest: 'RSUD Lumajang',
    totalCost: 1880000, block: '-',
  ...
  { id: 'rpt_ts_w8', salesId: 'tri', date: '2026-05-08', week: 'Minggu 2',
    ...
    pipeN: 1, pipeVal: 0, closest: 'RS Premier Surabaya',
    totalCost: 2280000, block: '-',
  ...
  { id: 'rpt_bi_w1', salesId: 'bagus', date: '2026-01-16', week: 'Minggu 3',
    ...
    pipeN: 3, pipeVal: 0, closest: 'RSUD Banyuwangi',
  ...
  { id: 'rpt_bi_w2', salesId: 'bagus', date: '2026-02-06', week: 'Minggu 1',
    ...
    pipeN: 2, pipeVal: 0, closest: 'RSUD Abdoer Rahem Situbondo',
  ...
  { id: 'rpt_bi_w3', salesId: 'bagus', date: '2026-02-20', week: 'Minggu 3',
    ...
    pipeN: 2, pipeVal: 0, closest: 'RSUD Banyuwangi',
    totalCost: 2280000, block: '-',
  ...
  { id: 'rpt_bi_w4', salesId: 'bagus', date: '2026-03-13', week: 'Minggu 2',
    ...
    pipeN: 1, pipeVal: 0, closest: 'RSUD Soebandi Jember',
    totalCost: 1850000, block: '-',
  ...
  { id: 'rpt_bi_w5', salesId: 'bagus', date: '2026-04-03', week: 'Minggu 1',
    ...
    pipeN: 3, pipeVal: 0, closest: 'RSUD Klungkung Bali',
  ...
  { id: 'rpt_bi_w6', salesId: 'bagus', date: '2026-04-24', week: 'Minggu 4',
    ...
    pipeN: 2, pipeVal: 0, closest: 'RSUD Iskak Tulungagung',
    totalCost: 1850000, block: '-',
  ...
  { id: 'rpt_bi_w7', salesId: 'bagus', date: '2026-05-15', week: 'Minggu 3',
    ...
    pipeN: 2, pipeVal: 0, closest: 'RS BaliMed Denpasar',
  ...
  { id: 'rpt_office_w1', salesId: 'office', date: '2026-02-05', week: 'Minggu 1',
    ...
    pipeN: 1, pipeVal: 0, closest: 'RS Pondok Indah Bintaro',
  ...
  { id: 'rpt_office_w2', salesId: 'office', date: '2026-03-15', week: 'Minggu 2',
    ...
    pipeN: 1, pipeVal: 0, closest: 'RS Premier Jatinegara',
  ...
  { id: 'rpt_office_w3', salesId: 'office', date: '2026-04-10', week: 'Minggu 2',
    ...
    pipeN: 1, pipeVal: 0, closest: 'RS Eka Hospital BSD',
  ...
  { id: 'rpt_office_w4', salesId: 'office', date: '2026-05-06', week: 'Minggu 1',
    ...
    pipeN: 1, pipeVal: 0, closest: 'RS Mayapada Kuningan',
  ...
  // ============= ICHA — Sales Staff baru bawah Dwi, mulai April 2026 ==============
  { id: 'rpt_icha_w1', salesId: 'icha', date: '2026-04-04', week: 'Minggu 1',
    ...
    visits: [
      { name: 'Kantor HNTI Jakarta', city: 'Jakarta Pusat', visit: 'first', product: '-', pipeline: 'cold', contact: 'dwi', note: 'Onboarding & product training minggu pertama, mempelajari portfolio HNTI' },
  ...
  { id: 'rpt_icha_w3', salesId: 'icha', date: '2026-04-25', week: 'Minggu 4',
    ...
    pipeN: 3, pipeVal: 0, closest: 'RS Hermina Jatinegara',
    totalCost: 850000, block: '-',
...
const SEED_IMPORT_RECORDS = [
  ...
  { id: 'imp_001', principal: 'Angell', principalCountry: 'China',
    ...
    importPermitNo: 'BAPETEN/IMP/2026/00451', pic: 'regulatory',
  ...
  { id: 'imp_002', principal: 'Angell', principalCountry: 'China',
    ...
    importPermitNo: 'BAPETEN/IMP/2026/00452', pic: 'regulatory',
    note: 'Izin Import terbit, lanjut pengajuan AKL Kemenkes' },
  { id: 'imp_003', principal: 'Angell', principalCountry: 'China',
    ...
    importPermitNo: null, pic: 'regulatory',
  ...
  { id: 'imp_004', principal: 'Innocare', principalCountry: 'Taiwan',
    ...
    importPermitNo: 'BAPETEN/IMP/2026/00280', pic: 'regulatory',
...
const SEED_PENGALIHAN_RECORDS = [
  { id: 'pgl_001', customer: 'RS Bhakti Wira Tamtama', modality: 'CT Scan',
    ...
    pic: 'regulatory', note: 'Pengalihan ke RS Bhakti Wira Tamtama disetujui' },
  { id: 'pgl_002', customer: 'RS Premier Bintaro', modality: 'MRI',
    ...
    pic: 'regulatory', note: 'Pengalihan ke RS Premier Bintaro disetujui' },
  { id: 'pgl_003', customer: 'RSUD Banyumas', modality: 'X-Ray',
    ...
    pic: 'regulatory', note: 'Sedang evaluasi - dokumen tambahan diminta' },
  { id: 'pgl_004', customer: 'RS Hermina Galaxy', modality: 'CT Scan',
    ...
    issuedDate: null, permitNo: null,
    pic: 'regulatory', note: 'Baru submit, menunggu nomor agenda' },
  { id: 'pgl_005', customer: 'RSUD Soewandhie Surabaya', modality: 'C-Arm',
    ...
    issuedDate: null, permitNo: null,
    pic: 'regulatory', note: 'Evaluasi BAPETEN, ETA 2 minggu' },
];
...
const SEED_INSTALL_RECORDS = [
  { id: 'inst_001', recordNo: 'BA-INST-2026-001', customer: 'RS Bhakti Wira Tamtama',
    ...
    leadTechnician: 'teknisi', teamSize: 3,
  ...
  { id: 'inst_002', recordNo: 'BA-INST-2026-002', customer: 'RS Premier Bintaro',
    ...
    leadTechnician: 'teknisi', teamSize: 4,
    roomReady: true, electricalReady: true, calibrationDone: true,
  ...
  { id: 'inst_003', recordNo: 'BA-INST-2026-003', customer: 'RSUD Banyumas',
    ...
    leadTechnician: 'teknisi2', teamSize: 2,
  ...
  { id: 'inst_005', recordNo: 'BA-INST-2026-005', customer: 'RS Husada Utama Surabaya',
    ...
    leadTechnician: 'teknisi3', teamSize: 2,
...
const SEED_BAST_RECORDS = [
  { id: 'bast_001', bastNo: 'BAST-HNTI-2026-001', customer: 'RS Bhakti Wira Tamtama',
    modality: 'CT Scan', subModality: 'CT 128 Slice Anatom Precision',
    signedDate: '2026-04-22', hntiRep: 'ceo',
  ...
  { id: 'bast_002', bastNo: 'BAST-HNTI-2026-002', customer: 'RS Premier Bintaro',
    modality: 'MRI', subModality: 'MRI 1.5T Supermark',
    signedDate: '2026-03-28', hntiRep: 'ceo',
  ...
  { id: 'bast_004', bastNo: 'BAST-HNTI-2026-004', customer: 'RSUD Cibinong',
    ...
    signedDate: '2026-02-15', hntiRep: 'ceo',
...
const SEED_TRAINING_RECORDS = [
  { id: 'train_001', certNo: 'CERT-HNTI-2026-001', customer: 'RS Bhakti Wira Tamtama',
    modality: 'CT Scan', subModality: 'CT 128 Slice Anatom Precision',
    sessionDate: '2026-04-21', participants: 4, instructor: 'teknisi + Engineer ANKE',
  ...
  { id: 'train_003', certNo: 'CERT-HNTI-2026-003', customer: 'RSUD Cibinong',
    modality: 'CT Scan', subModality: 'CT 32 Slice C201',
    sessionDate: '2026-02-12', participants: 3, instructor: 'teknisi',
...
const SEED_BUSINESS_TRIPS = [
  ...
  { id: 'bt_2026_001', requestNo: 'BT-2026-001',
    travelerUsername: 'tri', travelerName: '', position: 'Manager', allowancePerDay: 175000,
    ...
    bankAccount: { bankName: 'BCA', accountNo: '5210345678', holderName: '' },
    ...
    approvalHistory: [
      { level: 'submit', by: 'tri', byName: '', date: '2026-05-02', action: 'submitted', note: '' },
      { level: 'finance', by: 'finance', byName: '', date: '2026-05-03', action: 'approved', note: 'Estimasi biaya wajar untuk Surabaya 5 hari' },
      { level: 'manager_ops', by: 'manager_ops', byName: '', date: '2026-05-04', action: 'approved', note: 'Closing PO Premier Surabaya prioritas tinggi' },
      { level: 'gm', by: 'gm', byName: '', date: '2026-05-05', action: 'approved', note: 'Disetujui, proses transfer' },
      { level: 'finance', by: 'finance', byName: '', date: '2026-05-06', action: 'paid', note: 'Transfer BCA Rp 2.595.000' },
    ],
  ...
  { id: 'bt_2026_003', requestNo: 'BT-2026-003',
    travelerUsername: 'bagus', travelerName: '', position: 'Manager', allowancePerDay: 175000,
    ...
    bankAccount: { bankName: 'BNI', accountNo: '0123456789', holderName: '' },
    status: 'pending_finance', tripStatus: 'planned', paymentStatus: 'pending',
    paidDate: null, paidAmount: 0, paidProof: '',
    approvalHistory: [
      { level: 'submit', by: 'bagus', byName: '', date: '2026-05-17', action: 'submitted', note: '' },
    ],
  ...
  { id: 'bt_2026_004', requestNo: 'BT-2026-004',
    travelerUsername: 'teknisi', travelerName: '', position: 'Supervisor', allowancePerDay: 150000,
    ...
    bankAccount: { bankName: 'BRI', accountNo: '003901123456', holderName: '' },
    status: 'pending_gm', tripStatus: 'planned', paymentStatus: 'pending',
    paidDate: null, paidAmount: 0, paidProof: '',
    approvalHistory: [
      { level: 'submit', by: 'teknisi', byName: '', date: '2026-05-15', action: 'submitted', note: '' },
      { level: 'finance', by: 'finance', byName: '', date: '2026-05-16', action: 'approved', note: 'Estimasi biaya wajar untuk teknisi field 5 hari' },
      { level: 'manager_ops', by: 'manager_ops', byName: '', date: '2026-05-17', action: 'approved', note: 'Instalasi RSUD Banyumas urgent harus selesai' },
    ],
  ...
  { id: 'bt_2026_005', requestNo: 'BT-2026-005',
    travelerUsername: 'dwi', travelerName: '', position: 'Manager', allowancePerDay: 175000,
    ...
    bankAccount: { bankName: 'BCA', accountNo: '5210456789', holderName: '' },
    ...
    approvalHistory: [
      { level: 'submit', by: 'dwi', byName: '', date: '2026-04-28', action: 'submitted', note: '' },
      { level: 'finance', by: 'finance', byName: '', date: '2026-04-29', action: 'approved', note: 'OK' },
      { level: 'manager_ops', by: 'manager_ops', byName: '', date: '2026-04-30', action: 'approved', note: 'Closing Borromeus prioritas' },
      { level: 'gm', by: 'gm', byName: '', date: '2026-05-02', action: 'approved', note: 'Approved' },
      { level: 'finance', by: 'finance', byName: '', date: '2026-05-04', action: 'paid', note: 'Transfer BCA' },
    ],
  ...
  { id: 'bt_2026_006', requestNo: 'BT-2026-006',
    travelerUsername: 'hatim', travelerName: '', position: 'Staff', allowancePerDay: 130000,
    ...
    bankAccount: { bankName: 'Mandiri', accountNo: '1370012345678', holderName: '' },
    status: 'rejected', tripStatus: 'cancelled', paymentStatus: 'pending',
    paidDate: null, paidAmount: 0, paidProof: '',
    approvalHistory: [
      { level: 'submit', by: 'hatim', byName: '', date: '2026-05-14', action: 'submitted', note: '' },
      { level: 'finance', by: 'finance', byName: '', date: '2026-05-15', action: 'rejected', note: 'Durasi terlalu panjang untuk territory Jateng A. Mohon dipersingkat menjadi maks 4 hari dan submit ulang.' },
    ],
  ...
  { id: 'bt_2026_007', requestNo: 'BT-2026-007',
    travelerUsername: 'icha', travelerName: '', position: 'Staff', allowancePerDay: 130000,
    ...
    bankAccount: { bankName: 'BCA', accountNo: '5210999888', holderName: '' },
    status: 'clarification', tripStatus: 'planned', paymentStatus: 'pending',
    paidDate: null, paidAmount: 0, paidProof: '',
    approvalHistory: [
      { level: 'submit', by: 'icha', byName: '', date: '2026-05-15', action: 'submitted', note: '' },
      { level: 'finance', by: 'finance', byName: '', date: '2026-05-16', action: 'approved', note: 'OK' },
      { level: 'manager_ops', by: 'manager_ops', byName: '', date: '2026-05-17', action: 'clarification', note: 'Mohon konfirmasi: apakah perlu didampingi Dwi (Manager) untuk demo X-Ray? Jika ya, ajukan terpisah. Jika tidak, please update purpose dan submit ulang.' },
    ],
    submittedAt: '2026-05-15', updatedAt: '2026-05-17',
    realizationId: null,
  },
...
const SEED_BT_REALIZATIONS = [
  ...
  { id: 'btr_2026_001', realizationNo: 'BTR-2026-001',
    ...
    status: 'approved',
    approvalHistory: [
      { level: 'submit', by: 'dwi', byName: '', date: '2026-05-09', action: 'submitted', note: '' },
      { level: 'finance', by: 'finance', byName: '', date: '2026-05-10', action: 'approved', note: 'Semua bukti verified. Selisih kekurangan Rp 180.000 akan ditransfer.' },
      { level: 'manager_ops', by: 'manager_ops', byName: '', date: '2026-05-11', action: 'approved', note: 'OK, biaya wajar untuk closing Borromeus' },
      { level: 'gm', by: 'gm', byName: '', date: '2026-05-12', action: 'approved', note: 'Approved, proses settlement' },
    ],
...
const SEED_FIELD_REPORTS = [..._SEED_FIELD_REPORTS_BASE, ...FIELD_REPORTS_JUN_JUL_2026];
