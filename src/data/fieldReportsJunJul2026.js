// Auto-generated from HNTI_Import_Sales_Reports_All.csv — Juni–Juli 2026
// Regenerate: node scripts/build-field-reports-seed.mjs [path/to/csv]
const FIELD_REPORTS_JUN_JUL_2026 = [
  {
    id: "rpt_hatim_20260622_report",
    salesId: "hatim",
    date: "2026-06-22",
    week: "Minggu 4",
    days: 5,
    ...
    next: "Penawaran X-Ray RS Banyumanik 1, follow up C-Arm",
    fatigue: 2,
    visits: [
      {
  ...
  },
  {
    ...
    win: "",
    block: "",
    next: "Visit RS Charlie Demak, Sultan Agung, Pantiwilasa",
    fatigue: 2,
    visits: [
      {
        name: "RS SULTAN AGUNG",
        city: "",
        visit: "first",
        product: "",
        pipeline: "warm",
