  ...
  return (
    <div style={{minHeight: '100vh', background: 'var(--ims-bg)', fontFamily: 'Inter, sans-serif', color: 'var(--ims-text)'}}>
      ...
      <main className="main-content fade-in" style={{maxWidth: '1440px', margin: '0 auto', padding: '32px 48px 60px'}}>
        ...
        {view === 'sales_report' && canRead('sales_report') && <SalesReport reports={reports} setReports={setReports} t={t} lang={lang} session={session} fmt={fmt} employees={employees} reportsSeen={reportsSeen} setReportsSeen={setReportsSeen} issues={issues} installRecords={installRecords} />}
